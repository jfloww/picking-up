...
3. RF-005 is now resolved: nest, promotion, detach, occurrence deletion,
   reschedule, and reorder are all versioned, transactional server commands,
   and Task creation's `order` is server-computed.
